    ...
    <div className="min-h-screen bg-[#F4F2EF]">
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Button asChild className="bg-[#E68C3A] hover:bg-[#d67d2f] text-white rounded-full px-6 font-serif shadow-lg">
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Button className="bg-[#E68C3A] hover:bg-[#d67d2f] text-white text-2xl rounded-full px-12 py-6 font-serif shadow-2xl hover:scale-105 transition-transform">
            {t.bookNowCta}
          </Button>
        </div>
      </section>
