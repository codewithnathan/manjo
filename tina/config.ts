        ...
        fields: [
          ...
          },
          {
            ...
            fields: [
              ...
              { type: "string", name: "ourCommitment", label: "Our Commitment" },
              {
                type: "string",
              ...
              { type: "string", name: "reliableSupport", label: "Reliable Support" },
              {
                type: "string",
          ...
          },
          {
            ...
            fields: [
              ...
              { type: "string", name: "airlineTickets", label: "Airline Tickets" },
              {
                type: "string",
              ...
              { type: "string", name: "eventLogistics", label: "Event Logistics" },
              {
                type: "string",
